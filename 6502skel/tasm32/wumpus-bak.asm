...
draw_teeth:
    ...
    ld hl, 264; jump down a bunch of rows
    add hl, de
    ld d, h
    ld e, l
    call draw_lower_teeth;
...
draw_lwr_teeth_loop
    push bc
    call draw_lower_tooth
    pop bc
    djnz draw_lwr_teeth_loop
